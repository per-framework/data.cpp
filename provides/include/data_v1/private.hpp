...
template <class Value, ptrdiff_t Stride, size_t Size> struct strided;

class Private {
  template <class, ptrdiff_t> friend struct strided_iterator;
  template <class, ptrdiff_t, size_t> friend struct strided;

  template <class Value> class pointer_member {
    template <class, ptrdiff_t> friend struct data_v1::strided_iterator;
    template <class, ptrdiff_t, size_t> friend struct data_v1::strided;
